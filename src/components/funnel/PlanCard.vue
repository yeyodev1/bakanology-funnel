...
.plan {
  ...
  &__badge { display: flex; justify-content: center; align-items: center; width: auto; max-width: 100%; gap: 0.45rem; padding: 0.45rem 0.8rem; border: 1px solid rgba($primary, 0.55); border-radius: 999px; background: rgba($primary, 0.1); color: $primary; font-size: 0.8rem; font-weight: 900; letter-spacing: 0.07em; text-align: center; pointer-events: none; }
  ...
  &__regular { display: flex; justify-content: center; align-items: center; flex-wrap: wrap; width: 100%; gap: 0.5rem; color: $text-secondary; font-size: 0.8rem; font-weight: 800; letter-spacing: 0.07em; }
  ...
  &__saving { width: auto; padding: 0.4rem 0.7rem; border-radius: 999px; background: rgba($primary, 0.14); color: $primary; font-size: 0.8rem; font-weight: 900; letter-spacing: 0.06em; }
  ...
  &__button:hover { transform: translateY(-0.15rem); background: $secondary-dark; box-shadow: 0 0.9rem 1.8rem rgba($primary-dark, 0.28); }
  ...
  small { width: 100%; color: $text-secondary; font-size: 0.8rem; line-height: 1.5; text-align: center; }
}
</style>
